...
# resource "aws_route_table_association" "rte_tbl2_association" {
#   subnet_id      = aws_subnet.private-sub-1.id
#   route_table_id = aws_route_table.prv_rte_tbl.id
# }

# resource "aws_route_table_association" "rte_tbl3_association" {
#   subnet_id      = aws_subnet.public-sub-1.id
#   route_table_id = aws_route_table.pub_rte_tbl.id
# }

# resource "aws_route_table_association" "rte_tbl4_association" {
#   subnet_id      = aws_subnet.public-sub-2.id
#   route_table_id = aws_route_table.pub_rte_tbl.id
# }

# # resource "aws_route_table_association" "rte_tbl7_association" {
# #   subnet_id      = aws_subnet.public-3.id
# #   route_table_id = aws_route_table.rte_tbl1.id
# # }

# resource "aws_route_table_association" "rte_tbl5_association" {
#   subnet_id      = aws_subnet.private-sub-2.id
#   route_table_id = aws_route_table.prv_rte_tbl.id
# }

# resource "aws_route_table_association" "rte_tbl6_association" {
#   subnet_id      = aws_subnet.private-3.id
#   route_table_id = aws_route_table.rte_tbl2.id
# }
